...
public class Authenticate {
    ...
    public Authenticate() {
        ...
        secretString = Encoders.BASE64.encode("mysecuresecurecode123456789123456789123456789123456789".getBytes());
    ...
    public Entry<Boolean, String> verify(String jwt) throws UnsupportedEncodingException {
        ...
        try {
            jws = Jwts.parserBuilder() // (1)
                    .setSigningKey("mysecuresecurecode123456789123456789123456789123456789") // (2)
                    .build() // (3)
